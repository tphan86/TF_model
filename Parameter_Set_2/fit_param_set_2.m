%% Options of execution - paramter set 2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if Fit_ktr_porcine_LV_data
    ...
    ftns_1 = @(para_fit) norm(ktr_mean_porcine_LV - rate_force_redev_2(para_fit,pCa_porcine_LV));
    ...
    para_fit_1(19) = v;
    para_fit_1(20) = w;
    lower_bound_1 = [5.65;zeros(9,1);ones(4,1);ones(6,1)];
    upper_bound_1 = [5.65;Inf(9,1);ones(4,1);1;Inf;1;Inf;1;1];
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % t0 = clock;
...
if Fit_ktr_mouse_LV_data
    ...
    para_fit_3(19) = v;
    para_fit_3(20) = w;
    lower_bound_3 = [5.63;zeros(9,1);ones(4,1);ones(6,1)];
    upper_bound_3 = [5.64;Inf(9,1);ones(4,1);1;Inf;1;Inf;1;1];
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    t0 = clock;
    fprintf('\nStart Time: %4d-%02d-%02d %02d:%02d:%07.4f\n',t0)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % opts = optimoptions('lsqcurvefit','Algorithm','levenberg-marquardt');
    % 
    % % Fit the model to the mechanical data from mouse LV
...
if Fit_rel_SSF_porcine_LV_data
    ...
    para_fit_4(19) = v;
    para_fit_4(20) = w;
    lower_bound_4 = [5.65;zeros(9,1);ones(4,1);ones(6,1)];
    upper_bound_4 = [5.69;Inf(9,1);ones(4,1);1;Inf;1;Inf;1;1];
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % t0 = clock;
    % fprintf('\nStart Time: %4d-%02d-%02d %02d:%02d:%07.4f\n',t0)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if Fit_rel_SSF_mouse_LV_data
    ...
    para_fit_6(19) = v;
    para_fit_6(20) = w;
    lower_bound_6 = [5.79;zeros(9,1);ones(4,1);ones(6,1)];
    upper_bound_6 = [5.81;Inf(9,1);ones(4,1);1;Inf;1;Inf;1;1];
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % t0 = clock;
    % fprintf('\nStart Time: %4d-%02d-%02d %02d:%02d:%07.4f\n',t0)
    % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
