...
mouse_LV = load('fitted_mouse_LV_1.mat');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Extract the fitted parameters for porcine LV data
porcine_LV = load('fitted_porcine_LV_1.mat');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fitted_relktr_mouse_LV = rel_rate_force_redev(mouse_LV.ktr,pCa);
fitted_relktr_porcine_LV = rel_rate_force_redev(porcine_LV.ktr,pCa);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Figure
ax = gca;
...
title('Parameter set 1: relktr vs pCa','FontSize',30)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% set(0,'Units','normalized')
% set(gcf, 'PaperSize', [10 8], 'PaperPosition', [0 0 10 8])
% print('Figure3B','-djpeg')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%