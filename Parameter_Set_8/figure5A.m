...
fitted_ktr_mouse_LV = rate_force_redev_8(mouse_LV.ktr,pCa);
fitted_ktr_porcine_LV = rate_force_redev_8(porcine_LV.ktr,pCa);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Figure
ax = gca;
%%%%%%%%%
...
title('Parameter set 8: ktr vs pCa','FontSize',30)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% set(0,'Units','normalized')
% set(gcf, 'PaperSize', [10 8], 'PaperPosition', [0 0 10 8])
% print('Figure6A','-djpeg')